...
-m 16000 -n bradt_test_2_NEW_libraries -o /seq/tng/bradt/test_2_libraries_NEW.txt \
java -jar -Xmx16g picard-private_new.jar FindReadGroupDistributions \
TMP_DIR=/broad/hptmp/bradt \
O=/seq/tng/bradt/test_2_libraries.NEW \
